...
**v0.13.3 — Runtime helpers to reduce LLM boilerplate: followTargetWithShake, drawAllParticles, WASD_ARROWS preset, autoSubsystems in createGame.**
...
- ✅ 2240 TS (Node) + 2364 (V8) + 295 Rust tests passing
