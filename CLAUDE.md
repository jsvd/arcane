...
**Current status: v0.14.0 — TGS Soft physics solver with contact manifolds, soft constraints, speculative CCD. 2253 TS (Node) + 2377 (V8) + 338 Rust tests passing. Next: Phase 26 (Atmosphere).**
