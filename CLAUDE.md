...
**Current status: v0.12.1 — DX improvements. Unified Color API, particle presets, knockback, palette. 2110 TS (Node) + 2234 (V8) + 292 Rust tests passing. Next: Phase 26 (Atmosphere).**
