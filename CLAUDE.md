...
**Current status: v0.19.0 — Removed recipes, arcane add, bfrpg-crawler; API renames + .d.ts filtering. 2152 TS (Node) + 2155 (V8) + 351 Rust tests passing. Phases 0-28 complete.**
