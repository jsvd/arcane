...
**Current status: v0.13.1 — Template DX: iterative workflow guidance, concept-based file splitting, API doc fixes. 2227 TS (Node) + 2351 (V8) + 134 Rust tests passing. Next: Phase 26 (Atmosphere).**
