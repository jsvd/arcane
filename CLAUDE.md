...
**Current status: v0.13.0 — GPU geometry pipeline, Rust particles, render-to-texture FBOs, transform hierarchy, bulk ops, MCP bridge auto-relaunch. Next: Phase 26 (Atmosphere).**
